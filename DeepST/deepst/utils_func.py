...
def other_extra_info(adata, 
    ...
    # Create image
    # print(adata.obs["imagecol"].max(), adata.obs["imagerow"].max())
    max_size = np.max([abs(adata.obs["imagecol"].max()), abs(adata.obs["imagerow"].max())])
